      ...
      >
        <div class="flex flex-col">
          <div class="flex flex-row items-center gap-7 hover:bg-slate-700 w-60 p-2 rounded-xl">
            ...
            strokeWidth="{1.5}"
            stroke="currentColor"
            className="size-6 size-6 absolute inset-0 w-full h-full hidden svg-default"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
...
<style scoped>
.w-8.h-8.relative {
  position: relative; /* add this to ensure the hover effect works */
}

.w-8.h-8.relative:hover > .svg-default {
  opacity: 0;
}

.w-8.h-8.relative:hover > .svg-hover {
  opacity: 1;
}
